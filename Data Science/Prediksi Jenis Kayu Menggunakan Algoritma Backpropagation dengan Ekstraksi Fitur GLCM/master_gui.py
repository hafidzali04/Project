...
class MyFirstGUI:
    ...
    def __init__(self, master):
        ...
        self.master = master
        master.title("KLASIFIKASI JENIS KAYU MENGUNAKAN METODE GLCM DAN BACKPROPAGATION")
        ...
        self.lbHomog = tk.Label(self.frame3, text='HOMOGENEITY', anchor='w', bg='#947147', fg='white')
        ...
        self.lbEnergy = tk.Label(self.frame3, text='ENERGY', anchor='w', bg='#947147', fg='white')
        ...
        self.lbCor = tk.Label(self.frame3, text='CORRELATION', anchor='w', bg='#947147', fg='white')
        ...
        self.lbEnt = tk.Label(self.frame3, text='Entropy', anchor='w', bg='#947147', fg='white')
        ...
        self.hsBPNN.place(x=10, y=65, width=160, height=60)
    ...
    def fungsi_open(self):
        ...
        #self.citra_kayu = self.citra_kayu.resize((320,240), Image.ANTIALIAS)
    ...
    def fungsi_proses(self):
        ...
        self.hasil_pre = self.hasil_pre.resize((320,240), Image.ANTIALIAS)
