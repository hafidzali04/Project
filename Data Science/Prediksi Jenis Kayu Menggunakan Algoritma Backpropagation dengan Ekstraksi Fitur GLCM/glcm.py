...
def ekstraksi (citra):
    ...
    fitur = np.array([kontras, homogen, energi, korelasi, entropi, '5'])
    return fitur
...
datasets = glob.glob("../kayu/dataset/suren/*.jpg")
coba= training(datasets)

# print ("manual : ", coba)

df = pd.DataFrame(coba, columns= ['kontras','homogen','energi','korelasi','entropi','kelas'])
