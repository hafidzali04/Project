        ...
        <ul class="navbar-nav ml-auto">
          <li class="dropdown nav-item">
            ...
            <div class="dropdown-menu dropdown-with-icons">
              <a href="login-page-dokter.php" class="dropdown-item">
                <i class="material-icons">layers</i> Login Dokter
              </a>
            </div>
      ...
      <div class="row">
        <div class="col-lg-4 col-md-6 ml-auto mr-auto">
          <div class="card card-login">
            <form class="form" method="POST" action="proses_login.php">
              ...
              <p class="description text-center">Masukan Username Dan Password</p>
              <div class="card-body">
