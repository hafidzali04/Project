...
else
{
	echo "<script> alert('Silahkan Login Terlebih Dahulu !!');
			window.location.href='Login%20form/login-page-pegawai.php' </script>";
}
	...
	<div class="container">
		<div class="row">
			<div class="col-md-8 col-md-offset-2">
				...
				<form action="update_obat.php?id_ob=<?php echo $res['id_obat'];?>" method="POST" class="appointment-wrap animate-box">
					<div class="row form-group">
						<div class="col-md-6">
							<label for="fname">Nama</label>
							<input type="text" name="nama" class="form-control" value="<?php echo $res['nama_obat'];?>" placeholder="Nama Obat">
						</div>
					</div>
					...
					<div class="row form-group">
						<div class="col-md-12">
							...
							<select name="jenis" class="selectpicker form-control" >
							   ...
							   <option value="Kapsul" <?php if($res['jenis_obat']=='Kapsul') echo 'selected';?> >Kapsul</option>
							   <option value="Tablet" <?php if ($res['jenis_obat']=='Tablet') echo 'selected';?> >Tablet</option>
							   <option value="Sirup" <?php if ($res['jenis_obat']=='Sirup') echo 'selected';?> >Sirup</option>
							   <option value="Bubuk" <?php if ($res['jenis_obat']=='Bubuk') echo 'selected';?> >Bubuk</option>
							</select>
					...
					<div class="row form-group">
						<div class="col-md-6">
							...
							<input type="num" name="jml" class="form-control" value="<?php echo $res['jumlah_obat'];?>" placeholder="Jumlah Obat">
						</div>
					</div>
