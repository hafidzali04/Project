							...
							<ul>
								...
								<li class="has-dropdown">
									...
									<ul class="dropdown">
										...
										if (!empty($_SESSION['farmasi']) ) 
										{ ?>
										<li><a href="input_obat.php">Input Obat</a></li>
										<!--petugas pendaftaran -->
										<?php 
										}elseif (!empty($_SESSION['pendaftaran'])) { ?>
	...
	<div class="container">
			<div class="row">
				...
				<div class="col-md-8 col-md-offset-2">
					<form action="update_pasien.php?id_pas=<?php echo $res['no_rm'];?>" method="POST" class="appointment-wrap animate-box">
				
						<div class="row form-group">
							<div class="col-md-12">
								<label for="email">Nama</label>
								<input type="text" name="nama" class="form-control" value="<?php echo $res['nama_pasien'];?>" placeholder="Nama Pasien">
							</div>
						</div>
						...
						<div class="row form-group">
							<div class="col-md-12">
								...
								<input type="date" name="tanggal" class="form-control" value="<?php echo $res['tgl_lahir_pasien'];?>" placeholder="Tanggal">
							</div>
						</div>
						...
						<div class="row form-group">
							<div class="col-md-12">
								...
								<input type="text" name="alm" id="alm" class="form-control" value="<?php echo $res['alamat_pasien'];?>" placeholder="Alamat Pasien">
							</div>
						</div>

						<div class="row form-group">
							<div class="col-md-12">
								<label for="subject">Nomor Telpon</label>
								<input type="text" name="tel" class="form-control" value="<?php echo $res['no_hp_pasien'];?>" placeholder="Nomor Telpon">
							</div>
						</div>
						...
						<div class="row form-group">
							<div class="col-md-12">
								...
								<select name="agama" class="selectpicker form-control" required>
								   <option value="-"></option>
						...
						<div class="row form-group">
							<div class="col-md-12">
								...
								<select name="pekerjaan" class="selectpicker form-control">
								   <option value="-" disabled></option>
								   <option value="1">Belum Kerja</option>
								   <option value="2">Kerja</option>
								   <option value="3">Pelajar</option>
								   <option value="4">Pegawai Negri Sipil</option>
						...
						<div class="row form-group">
							<div class="col-md-12">
								<label for="subject">Nama Keluarga</label>
								<input type="text" name="namkel" class="form-control" value="<?php echo $res['nama_keluarga'];?>" placeholder="Nomor Telpon">
							</div>
						</div>
						
						<div class="form-group">
							<input type="submit" name="input" value="Edit Data Pasien" class="btn btn-primary">
						</div>
