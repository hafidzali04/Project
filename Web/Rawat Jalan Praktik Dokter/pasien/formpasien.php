	...
	<div class="container">
			<div class="row">
				...
				<div class="col-md-8 col-md-offset-2">
					<form action="input_pasien.php?user=<?php echo  $data['id_user'];?>" method="POST" class="appointment-wrap animate-box">
						<div class="row form-group">
							<div class="col-md-12">
								<label for="email">No RM</label>
								<input type="text" name="no_rm" class="form-control" placeholder="Nomor Rekam menis">
							</div>
						</div>
						...
						<div class="row form-group">
							<div class="col-md-6">
								...
								<input type="date" name="tgl_daftar" class="form-control" placeholder="Tanggal Pendaftaran">
							</div>
						</div>
						...
						<div class="row form-group">
							<div class="col-md-12">
								...
								<input type="text" name="tel" class="form-control" placeholder="Nomor Telepon">
							</div>
						</div>
						...
						<div class="row form-group">
							<div class="col-md-12">
								...
								<select name="agama" class="selectpicker form-control">
								   <option value="-"></option>
						...
						<div class="row form-group">
							<div class="col-md-12">
								...
								<input type="text" name="namkel" class="form-control" placeholder="Nama Keluarga Pasien">
							</div>
						</div>
