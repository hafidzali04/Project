	...
	<div class="container">
			...
			<div class="row">
				...
				<div class="col-md-8 col-md-offset-2">
					...
					<?php
                    if(isset($_GET['carikey']))
                    {
                    	$cari  = $_GET['carikey'];

                        // echo $cari." ini";
                        $da  = mysqli_query($koneksi, "SELECT * FROM tb_pasien WHERE no_rm LIKE '%$cari%'");
					    $result=mysqli_fetch_array($da);
					    $query  = mysqli_query($koneksi, "SELECT * FROM tb_pasien WHERE no_rm LIKE '%$cari%'");
